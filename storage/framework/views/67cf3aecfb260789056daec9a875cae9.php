...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img src="<?php echo e(Vite::asset('resources/images/logo-white.svg')); ?>" alt="logo" class="img-fluid"
                    style="width: 40px" />
            </a>
                ...
                <div class="offcanvas-body pt-0 px-4">
                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active"><i class="bi-github"><small
                                        class="ms-2 d-md-none">Github</small></i></a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active"><i class="bi-twitter"><small
                                        class="ms-2 d-md-none">Twitter</small></i></a>
                        </li>
                        <li class="nav-item col-6 col-md-auto">
                            <a href="#" class="nav-link active"><i class="bi-slack"><small
                                        class="ms-2 d-md-none">Slack</small></i></a>
                        </li>
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                <button type="button" class="btn nav-link text-white dropdown-toggle"
                                    data-bs-toggle="dropdown" aria-expanded="false"><span
                                        class="d-lg-none">Bootstrap</span> v5.3</button>
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                <button type="button" class="btn nav-link text-white dropdown-toggle"
                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="bi-brightness-high-fill"></i><span class="d-lg-none">Toggle
                                        theme</span></button>
                                <ul class="dropdown-menu dropdown-menu-end">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img src="<?php echo e(Vite::asset('resources/images/main.svg')); ?>" alt="main" class="img-fluid" />
                </div>
                <div class="col-md-7 order-md-1">
                    <h1 class="mt-4 display-3">Build fast, responsive sites with Bootstrap</h1>
                    <p class="fs-5 mt-3">
                        Quickly design and customize responsice mobile-first sites with Bootstrap, the world's most
                        popular front-end open source toolkit, featuring Sass variables and mixins, responsive frid
                    ...
                    <div class="row">
                        ...
                        <div class="text-muted">Currently <strong>v5.3.0-alpha2.</strong> · <a href="#">v.4.6.x
                                docs</a> · <a href="#">All releases</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">
                        <a href="#">Bootstrap Icons</a> is an open source SVG icon library featuring over 1,800
                        glyphs, with more added every release. They're designed to work in any project, whether you use
                        Bootstrap itself or not. Use them as SVGs
                ...
                <div class="col-lg-6">
                    <img src="<?php echo e(Vite::asset('resources/images/bs-icons.png')); ?>" alt="Bootstrap Icons"
                        class="img-fluid" />
                </div>
            </div>
        </div>
    ...
    <div id="bs-themes">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3 mt-5"><i
                            class="bi bi-droplet-fill fs-2 bg-info py-2 px-3 rounded-3 text-white"></i></div>
                    <h2 class="display-5">Make it yours with official Bootstrap Themes</h2>
                    <p class="fs-5">
                        Take Boostrap to the next level with premium themes from the <a href="#">official
                ...
                <div class="col-lg-6"><img src="<?php echo e(Vite::asset('resources/images/bs-themes.png')); ?>"
                        alt="Bootstrap Themes" class="img-fluid" /></div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoreation-none">
                        <div class="d-flex">
                            <img src="<?php echo e(Vite::asset('resources/images/logo-black.svg')); ?>" alt="Bootstrap Logo"
...
<?php /**PATH D:\FemWokPurp\PrakMod03\resources\views/bootstrapclone.blade.php ENDPATH**/ ?>