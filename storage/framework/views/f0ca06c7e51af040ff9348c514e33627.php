...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/titile/this-is-my-title')); ?>" class="list-group-item list-group-item-action">
        ...
        <div class="list-group list-group-numbered mt-4">
            <a href="<?php echo e(url('/bootstrapclone')); ?>" class="list-group-item list-group-item-action">
                Bootstrap Clone Implementation
            </a>
        </div>
...
<?php /**PATH D:\FemWokPurp\PrakMod03\resources\views/routing.blade.php ENDPATH**/ ?>